        ...
        for aspect, sentiment_list in sentence_maps.items():
            if aspect in aspects:
                ...
                for sentence in sentiment_list:
                    ...
                    pos_total = pos_count / total_count
                    neg_total = neg_count / total_count
                count_dict[aspect_label] = {'pos-count': pos_count, 'neg-count': neg_count, 'pos-percent': (pos_total*100), 'neg-percent': (neg_total*100)}
    return count_dict
