...
def groupAspects(aspect_list, sentences):
    ...
    for i in range(kmeans.n_clusters):
        ...
        for cluster_aspect in cluster_aspects:
            used_aspects.add(cluster_aspect)
        aspect_counts = Counter([aspect for sentence in sentences for aspect in used_aspects if aspect in sentence])
        most_common_aspect = aspect_counts.most_common(1)[0][0]
        labels.append(most_common_aspect)
        grouped_aspects[most_common_aspect] = used_aspects
